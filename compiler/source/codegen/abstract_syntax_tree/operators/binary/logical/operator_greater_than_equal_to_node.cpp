...
namespace channel {
	...
	bool operator_greater_than_equal_to_node::accept(visitor& visitor, value_ptr& out_value, codegen_context context) {
		return visitor.visit_operator_greater_than_equal_to_node(*this, out_value, context);
	}
