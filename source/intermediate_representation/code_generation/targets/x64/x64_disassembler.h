...
#include "intermediate_representation/code_generation/targets/disassembler_base.h"
...
namespace ir::cg::x64 {
	...
	class x64_disassembler : public disassembler_base {
	public:
		utility::string disassemble(
	...
	private:
		...
		static u64 emit_get_label(const codegen_context& context, u32 position);
