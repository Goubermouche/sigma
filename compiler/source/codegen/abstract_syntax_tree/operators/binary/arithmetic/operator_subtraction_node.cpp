...
namespace channel {
	...
	bool operator_subtraction_node::accept(visitor& visitor, value_ptr& out_value, codegen_context context) {
		return visitor.visit_operator_subtraction_node(*this, out_value, context);
	}
