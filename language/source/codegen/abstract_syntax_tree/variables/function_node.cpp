...
namespace channel {
	function_node::function_node(u64 line_number, type return_type, const std::string& name, std::vector<node*> statements)
		: node(line_number), m_return_type(return_type), m_name(name), m_statements(std::move(statements)) {}
