#include "operator_division_assignment_node.h"
...
namespace channel {
	...
	acceptation_result operator_division_assignment_node::accept(code_generator& visitor, const codegen_context& context) {
		return visitor.visit_operator_division_assignment_node(*this, context);
	}

	void operator_division_assignment_node::print(u64 depth, const std::wstring& prefix, bool is_last) {
