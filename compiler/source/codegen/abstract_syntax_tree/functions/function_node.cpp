...
namespace channel {
	function_node::function_node(u64 line_number, type return_type, const std::string& name, const std::vector<node*>& statements, const std::vector<std::pair<std::string, type>>& arguments)
		: node(line_number), m_return_type(return_type), m_name(name), m_statements(statements), m_arguments(arguments) {}
