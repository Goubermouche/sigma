...
namespace channel {
	global_declaration_node::global_declaration_node(u64 line_number, const type& declaration_type, const std::string& declaration_identifier, node_ptr expression_node)
	...
	void global_declaration_node::print(int depth, const std::wstring& prefix, bool is_last) {
		...
		node_ptr expression = get_expression_node();
