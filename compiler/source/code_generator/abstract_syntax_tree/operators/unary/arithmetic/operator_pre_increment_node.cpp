#include "operator_pre_increment_node.h"

namespace channel {
	operator_pre_increment_node::operator_pre_increment_node(
		const token_position& position,
		const node_ptr& expression_node
	) : operator_unary_base(position, expression_node) {}

	acceptation_result operator_pre_increment_node::accept(code_generator& visitor, const code_generation_context& context) {
