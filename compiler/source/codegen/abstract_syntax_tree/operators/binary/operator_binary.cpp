...
namespace channel {
	operator_binary::operator_binary(u64 line_number, node_ptr left_expression_node, node_ptr right_expression_node)
	...
	node_ptr operator_binary::get_left_expression_node() const {
		return m_left_expression_node;
	}
	node_ptr operator_binary::get_right_expression_node() const {
