...
namespace ir {
	...
	public:
		...
		virtual ~x64_architecture() = default;
	private:
		...
		auto create_instruction(codegen_context& context, instruction::type type, data_type data_type, u8 out_count, u8 in_count, u8 tmp_count) -> handle<instruction> {
		...
		static void emit_instruction_2(instruction::type type, handle<value> a, handle<value> b, i32 data_type, utility::byte_buffer& bytecode);

		static void emit_memory_operand(u8 rx, handle<value> a, utility::byte_buffer& bytecode);
