...
namespace channel {
	local_declaration_node::local_declaration_node(u64 line_number, const type& declaration_type, const std::string& declaration_identifier, node_ptr expression_node)
