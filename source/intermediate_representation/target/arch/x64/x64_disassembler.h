...
namespace sigma::ir {
	...
	public:
		auto disassemble(const utility::byte_buffer& bytecode, const codegen_context& context) -> std::stringstream override;
	private:
		static handle<symbol_patch> disassemble_block(const utility::byte_buffer& bytecode, const codegen_context& context, handle<symbol_patch> patch, u64 basic_block, utility::range<u64> range, std::stringstream& assembly);
