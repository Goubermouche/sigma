...
namespace channel {
	array_allocation_node::array_allocation_node(u64 line_number, const type& array_element_type, node_ptr array_element_count_node)
	...
	node_ptr array_allocation_node::get_array_element_count_node() const {
