...
namespace channel {
	...
	bool operator_post_increment::accept(visitor& visitor, value_ptr& out_value, codegen_context context) {
		return visitor.visit_operator_post_increment_node(*this, out_value, context);
	}
