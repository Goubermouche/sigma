#include "operator_bitwise_left_shift_node.h"
...
namespace channel {
	...
	acceptation_result operator_bitwise_left_shift_node::accept(code_generator& visitor, const code_generation_context& context) {
		return visitor.visit_operator_bitwise_left_shift_node(*this, context);
	}

	void operator_bitwise_left_shift_node::print(u64 depth, const std::wstring& prefix, bool is_last) {
